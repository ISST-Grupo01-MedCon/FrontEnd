                ...
                <p style = {{fontSize: 40, fontWeight: "bold"}}>Bienvenido de nuevo: Dr. {props.doc}</p>
                    ...
                    <Col>
                        <Stack style={{border: "none"}} gap={5}>
                            ...
                            <Row style={{justifyContent: "center"}}><Button style={{...blueButton, height: 150, width: 400, fontSize: 30}} onClick={() =>  {props.cambiarModoConsultaPaciente("llamado", siguienteConsulta, "consulta"); navigate("/medico/detalles_paciente/"+siguienteConsulta.id);}} size="lg">Llamar al siguiente paciente</Button></Row>
                        </Stack>
                    </Col>
                </Row>
            </Col>
